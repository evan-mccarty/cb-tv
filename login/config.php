...
$site_name = 'CBI Restrictions Control Panel';
...
$from_name = 'CBI Restrictions Portal Verify'; //"From name" displayed on email
...
$signupthanks = 'You will receive email notification once your account has been reviewed';
